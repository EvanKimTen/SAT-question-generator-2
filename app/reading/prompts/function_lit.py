...
4. Literary Names and Titles: If the passage, the question or the answer choices mention a title of an article, an essay, a chapter, a poem, a short story, a web page, a song, or a speech name, then there must be double quotation marks around that name (for example, “In My Life” is the title of a song by Beatles). 
