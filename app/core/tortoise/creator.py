...
def pydantic_model_creator(
    ...
    *,
    ...
    if not hasattr(default_config_class, "title") and not hasattr(
        config_class, "title"
    ):
    ...
    if not hasattr(default_config_class, "extra") and not hasattr(
        config_class, "extra"
    ):
...
def pydantic_queryset_creator(
    ...
    *,
    ...
    setattr(
        model.__config__,
        "title",
        name or f"{getattr(submodel.__config__,'title')}_list",
    )
